...
export class CreateVariantesDto {
  @ApiProperty({
    description: 'Nombre del Variantes',
    example: 'Variantes Centro-Norte',
    maxLength: 100,
    type: String,
  })
  ...
  @ApiPropertyOptional({
    description: 'Distancia total del Variantes en kilómetros',
    example: 15.75,
    type: Number,
    minimum: 0,
    maximum: 9999.99,
  ...
  @ApiPropertyOptional({
    description: 'Estatus del Variantes (1 = Activo, 0 = Inactivo)',
    example: 1,
    type: Number,
    enum: [0, 1],
    default: 1,
  ...
  @ApiProperty({
    description: 'ID de la ruta a la que pertenece el Variantes',
    example: 1,
    type: Number,
    minimum: 1,
  })
