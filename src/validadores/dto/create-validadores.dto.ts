...
export class CreateValidadoresDto {
  @IsString()
  ...
  @ApiProperty({
    description: "Número de serie único del Validadores",
  ...
  @ApiProperty({ description: "Marca del Validadores", example: "Samsung" })
  marca: string;

  @IsString()
  @IsNotEmpty({ message: "El modelo es obligatorio" })
  @MaxLength(100, { message: "El modelo no puede exceder 100 caracteres" })
  @ApiProperty({ description: "Modelo del Validadores", example: "Galaxy X1" })
  modelo: string;
  ...
  @ApiProperty({
    description: "Id del cliente propietario del Validadores",
    example: 5,
  })
  idCliente: number;
}
